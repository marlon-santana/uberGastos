    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.cardsRow}>
          ...
          <SummaryCard label="Despesas" value={metrics.expense} tone="expense" />
        </View>
      ...
      <AddTransactionModal visible={isModalOpen} onClose={() => setModalOpen(false)} onSubmit={addTransaction} />
    </View>
  );
}
