...
import { AddFixedCostModal, FixedCostsList } from '@/features/fixedCosts/components';
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <Card>
          ...
          <Text style={styles.headerAmount}>R$ {totalDailyAmount.toFixed(2)}/dia</Text>
          <Text style={styles.headerSubtext}>
            Você precisa fazer este valor por dia para pagar todos os custos fixos nos prazos estabelecidos.
          </Text>
        </Card>
      </View>
